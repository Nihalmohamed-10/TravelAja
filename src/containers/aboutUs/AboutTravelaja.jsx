...
function AboutTravelaja() {
  return (
    <div className="text-center flex flex-wrap gap-8 justify-evenly items-center pb-20 lg:text-start md:text-start">
      <div className="flex flex-col gap-3 max-w-[60%] lg:max-w-[47%] xl:w-54%">
