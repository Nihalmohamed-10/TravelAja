...
function TravelersPoint() {
  return (
    <div className="flex flex-col gap-70 mt-50 justify-evenly items-center lg:flex-row  lg:mt-20 ">
      ...
      <div className="text-center flex flex-col gap-4 w-[100%] p-5 md:w-[44%] md:gap-0px lg:text-start lg:w-[34%] xl:w-[40%] ">
        ...
        <p className="mx-auto text-[16px] w-[100%] text-[#3D3E48] xl:w-full">
